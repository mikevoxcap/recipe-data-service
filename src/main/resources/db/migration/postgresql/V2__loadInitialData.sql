...
INSERT INTO recipe."recipe_category" (recipe_id, category_id, created_by, created_timestamp) 
	VALUES ((SELECT recipe_id from recipe."recipe" WHERE recipe_name = 'Boiled Water'), 
		(SELECT category_id FROM recipe."category" WHERE category_name = 'Simple'), 'admin', '2017-02-02 01:01:01');
			
INSERT INTO recipe."recipe_ingredient" 
...
INSERT INTO recipe."recipe_instruction" (recipe_id, instruction_value, sequence_number, created_by, created_timestamp)
...
INSERT INTO recipe."recipe_review" (user_id, recipe_id, review_rating, review_comment, created_by, created_timestamp) 
