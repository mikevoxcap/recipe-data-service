...
public class RecipeReviewRepositoryTest {
   ...
   public void testFindAllSuccess() {
      List<RecipeReview> recipeReviews = recipeReviewRepository.findAll();
      assertNotNull(recipeReviews);
      assertFalse(recipeReviews.isEmpty());
   }
